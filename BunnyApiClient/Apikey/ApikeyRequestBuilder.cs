...
namespace BunnyApiClient.Apikey
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="BunnyApiClient.Apikey.ApikeyRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="BunnyApiClient.Apikey.ApikeyRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        ...
        /// [ListApiKeys API Docs](https://docs.bunny.net/reference/apikeypublic_listapikeys)
        /// </summary>
        public class ApikeyRequestBuilderGetQueryParameters 
        {
            [QueryParameter("page")]
