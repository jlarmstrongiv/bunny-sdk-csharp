...
#nullable enable
        public async Task<global::BunnyApiClient.Models.User.User?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::BunnyApiClient.Models.User.User> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::BunnyApiClient.Models.User.User>(requestInfo, global::BunnyApiClient.Models.User.User.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// [GetUserDetails API Docs](https://docs.bunny.net/reference/userpublic_index)
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::BunnyApiClient.User.UserRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::BunnyApiClient.User.UserRequestBuilder WithUrl(string rawUrl)
        {
            return new global::BunnyApiClient.User.UserRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
