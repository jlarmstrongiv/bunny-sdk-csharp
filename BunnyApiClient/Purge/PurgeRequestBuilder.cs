...
namespace BunnyApiClient.Purge
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="BunnyApiClient.Purge.PurgeRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="BunnyApiClient.Purge.PurgeRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        ...
        /// [PurgeUrlGet API Docs](https://docs.bunny.net/reference/purgepublic_index)
        /// </summary>
        public class PurgeRequestBuilderGetQueryParameters 
        {
...
#nullable restore
        ...
        /// [PurgeUrlPost API Docs](https://docs.bunny.net/reference/purgepublic_indexpost)
        /// </summary>
        public class PurgeRequestBuilderPostQueryParameters 
        {
            [QueryParameter("async")]
            public bool? Async { get; set; }
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
