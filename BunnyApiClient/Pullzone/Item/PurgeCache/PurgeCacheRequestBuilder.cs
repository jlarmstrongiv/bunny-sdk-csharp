...
namespace BunnyApiClient.Pullzone.Item.PurgeCache
{
    ...
    /// </summary>
    public class PurgeCacheRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="BunnyApiClient.Pullzone.Item.PurgeCache.PurgeCacheRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="BunnyApiClient.Pullzone.Item.PurgeCache.PurgeCacheRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
