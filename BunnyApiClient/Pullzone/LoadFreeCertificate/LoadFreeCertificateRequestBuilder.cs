...
namespace BunnyApiClient.Pullzone.LoadFreeCertificate
{
    ...
    /// </summary>
    public class LoadFreeCertificateRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="BunnyApiClient.Pullzone.LoadFreeCertificate.LoadFreeCertificateRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="BunnyApiClient.Pullzone.LoadFreeCertificate.LoadFreeCertificateRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        ...
        /// [LoadFreeCertificate API Docs](https://docs.bunny.net/reference/pullzonepublic_loadfreecertificate)
        /// </summary>
        public class LoadFreeCertificateRequestBuilderGetQueryParameters 
        {
