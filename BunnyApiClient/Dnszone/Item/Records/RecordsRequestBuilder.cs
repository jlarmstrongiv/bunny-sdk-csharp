    ...
    public partial class RecordsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::BunnyApiClient.Dnszone.Item.Records.Item.RecordsItemRequestBuilder this[long position]
        {
            get
            {
                ...
                return new global::BunnyApiClient.Dnszone.Item.Records.Item.RecordsItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        ...
        public RecordsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/dnszone/{%2Did}/records", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::BunnyApiClient.Dnszone.Item.Records.RecordsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RecordsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/dnszone/{%2Did}/records", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        public async Task<global::BunnyApiClient.Models.DnsZone.UpdateDnsRecord.DnsRecord> PutAsync(global::BunnyApiClient.Dnszone.Item.Records.RecordsPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::BunnyApiClient.Models.DnsZone.UpdateDnsRecord.DnsRecord>(requestInfo, global::BunnyApiClient.Models.DnsZone.UpdateDnsRecord.DnsRecord.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// [AddDnsRecord API Docs](https://docs.bunny.net/reference/dnszonepublic_addrecord)
        /// </summary>
...
#nullable restore
        ...
        {
            return new global::BunnyApiClient.Dnszone.Item.Records.RecordsRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
