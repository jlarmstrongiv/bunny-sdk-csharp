...
namespace BunnyApiClient.Dnszone.Item.Recheckdns
{
    ...
    /// </summary>
    public class RecheckdnsRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="BunnyApiClient.Dnszone.Item.Recheckdns.RecheckdnsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="BunnyApiClient.Dnszone.Item.Recheckdns.RecheckdnsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
