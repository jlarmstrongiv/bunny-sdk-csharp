...
namespace StreamApiClient.OEmbed
{
    ...
    /// </summary>
    public class OEmbedRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="StreamApiClient.OEmbed.OEmbedRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="StreamApiClient.OEmbed.OEmbedGetResponse"/></returns>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="StreamApiClient.OEmbed.OEmbedRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        ...
        /// [OEmbed API Docs](https://docs.bunny.net/reference/oembed_getoembed)
        /// </summary>
        public class OEmbedRequestBuilderGetQueryParameters 
        {
