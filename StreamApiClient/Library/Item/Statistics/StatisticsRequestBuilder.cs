...
namespace StreamApiClient.Library.Item.Statistics
{
    ...
    public class StatisticsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="StreamApiClient.Library.Item.Statistics.StatisticsGetResponse"/></returns>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="StreamApiClient.Library.Item.Statistics.StatisticsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
