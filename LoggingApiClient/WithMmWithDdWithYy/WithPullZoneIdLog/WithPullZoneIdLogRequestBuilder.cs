...
namespace LoggingApiClient.WithMmWithDdWithYy.WithPullZoneIdLog
{
    ...
    /// </summary>
    public class WithPullZoneIdLogRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="LoggingApiClient.WithMmWithDdWithYy.WithPullZoneIdLog.WithPullZoneIdLogRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="LoggingApiClient.WithMmWithDdWithYy.WithPullZoneIdLog.WithPullZoneIdLogRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        ...
        /// [LoggingApi API Docs](https://docs.bunny.net/docs/cdn-logging-api)
        /// </summary>
        public class WithPullZoneIdLogRequestBuilderGetQueryParameters 
        {
            [QueryParameter("end")]
